      ...
      <div className="container-custom py-section-sm">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block">
              <span className="font-heading text-xl font-bold text-[#0e1629]">
                Security<span className="text-emerald-600">Tests</span>
              </span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed max-w-xs">
              Professional-grade security testing tools and kits trusted by ethical hackers and security researchers worldwide.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} SecurityTests. All rights reserved.
          </p>
